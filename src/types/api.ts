...
export class Convert {
  public static toLaunch(json: string): APISpaceX {
    return cast(JSON.parse(json), r('Launch'));
  }

  public static launchToJson(value: APISpaceX): string {
    return JSON.stringify(uncast(value, r('Launch')), null, 2);
  }
}
